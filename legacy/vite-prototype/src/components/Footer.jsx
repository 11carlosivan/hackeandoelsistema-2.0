    ...
    <footer className="w-full py-stack-lg border-t border-terminal-gray bg-surface-container-lowest mt-section-gap">
      <div className="w-full px-margin-page flex flex-col md:flex-row justify-between items-center max-w-full mx-auto gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <Link className="text-on-surface-variant font-label-caps text-label-caps hover:text-white transition-opacity opacity-70 hover:opacity-100" to="/pagina/terms-of-service">
            Términos de Servicio
          </Link>
          <Link className="text-on-surface-variant font-label-caps text-label-caps hover:text-white transition-opacity opacity-70 hover:opacity-100" to="/pagina/privacy-policy">
            Privacidad
          </Link>
          <Link className="text-on-surface-variant font-label-caps text-label-caps hover:text-white transition-opacity opacity-70 hover:opacity-100" to="/contacto-seguro">
            Contacto Seguro
          </Link>
          <Link className="text-on-surface-variant font-label-caps text-label-caps hover:text-white transition-opacity opacity-70 hover:opacity-100" to="/pagina/advertising">
            Publicidad
          </Link>
          <Link className="text-system-red font-label-caps text-label-caps underline transition-opacity opacity-70 hover:opacity-100" to="/contacto-seguro">
