...
import { articles, opinions, authors } from '../data/mockData';
  ...
  return (
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        {currentHero && (
          <section 
            onClick={() => navigate(`/articulo/${currentHero.id}`)}
            ...
            >
              ...
              <div className="relative z-20">
                ...
                <span className="text-[8px] text-on-surface-variant font-mono uppercase mt-1 block">
                  Hace {Math.floor(Math.random() * 3) + 1} horas
                </span>
              </div>
            </div>
          ))}
                ...
                <div className="px-4 pb-4 pt-2 border-t border-terminal-gray/30 flex justify-between items-center text-[9px] font-mono text-on-surface-variant">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <button 
                      onClick={(e) => {
                        e.stopPropagation();
                        navigate(`/articulo/${art.id}#comentarios-seccion`);
                      }}
